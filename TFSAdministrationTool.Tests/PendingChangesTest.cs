...
namespace TFSAdministrationTool.Tests
{
  ...
  public class PendingChangesTest
  {
    ...
    public void Add_NoConflictTest()
    {
      ...
      target.Add(false, false, "TU", "TestUser", ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.TeamFoundation, "Role1");
      Assert.AreEqual<int>(1, target.All.Count, "Not Checked, Not Selected");

      target.Add(true, false, "TU", "TestUser", ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.TeamFoundation, "Role1");
      ...
      target.Add(false, true, "TU", "TestUser", ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.TeamFoundation, "Role1");
    ...
    public void Add_OppositePendingChangeExistTest()
    {
      ...
      target.Add(false, false, "TU", "TestUser", ChangeType.Delete, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.TeamFoundation, "Role1");
