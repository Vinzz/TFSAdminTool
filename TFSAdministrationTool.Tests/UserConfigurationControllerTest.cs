...
namespace TFSAdministrationTool.Tests
{
  ...
  public class UserConfigurationControllerTest
  {
    ...
    public void AddUserWithPendingChangesTest()
    {
      ...
      MainController.PendingChanges.Add(true, true, user.UserName, user.DisplayName, ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.TeamFoundation, "TestRole");
