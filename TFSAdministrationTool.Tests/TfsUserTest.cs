...
namespace TFSAdministrationTool.Tests
{
  ...
  public class TfsUserTest
  {
    ...
    public void TfsUserCollectionNewUserApplyPendingChangesTest()
    {
      ...
      pendingChanges.Add(Guid.NewGuid(), new PendingChange(true, false, @"domain\username", "UserName", ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.TeamFoundation, "Project Administrators"));
      pendingChanges.Add(Guid.NewGuid(), new PendingChange(true, false, @"domain\username", "UserName", ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.SharePoint, "Full Control"));
      pendingChanges.Add(Guid.NewGuid(), new PendingChange(true, false, @"domain\username", "UserName", ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.ReportingServices, "Content Manager"));
      ...
      pendingChanges.Add(Guid.NewGuid(), new PendingChange(true, false, @"domain\username", "UserName", ChangeType.Delete, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.ReportingServices, "Content Manager"));
      ...
      pendingChanges.Clear();
      pendingChanges.Add(Guid.NewGuid(), new PendingChange(true, false, @"domain\username", "UserName", ChangeType.Delete, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.TeamFoundation, "All"));
    ...
    public void TfsUserCollectionUserApplyPendingChangesTest()
    {
      ...
      Dictionary<Guid, PendingChange> pendingChanges = new Dictionary<Guid, PendingChange>();
      pendingChanges.Add(Guid.NewGuid(), new PendingChange(true, false, @"domain\username", "UserName", ChangeType.Add, m_mockTFS.SelectedTeamProject, m_mockTFS.Server.Name, m_mockTFS.Server.InstanceId, SystemTier.SharePoint, "Read"));
