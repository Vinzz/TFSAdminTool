...
namespace TFSAdministrationTool.Proxy
{
    ...
    {
        void SetClaimBasedAuthenticationMode(bool param);
    ...
    {
        #region Fields
        private string claimBasedAuthentPrefix;
        ...
        /// </summary>
        /// <param name="userName">Name of the user</param>
        /// <param name="group">Name of the group that he is assigned</param>
        /// <param name="displayName">Display Name</param>
        /// <param name="email">User's email address</param>
        /// <param name="description">A descripton/comments field about the user</param>
        /// ite
        ...
        public void RemoveUser(string userName)
        {
            ...
            {
                m_UserGroup.RemoveUserFromRole(assignedRole, userNameParam);
            }

            List<string> assignedGroups = GetGroupCollectionFromUser(userNameParam);

            foreach (string assignedGroup in assignedGroups)
            {
                m_UserGroup.RemoveUserFromGroup(assignedGroup, userNameParam);
            }
        }
        ...
        /// <summary>
        /// Sets the claim based authentication mode.
        /// </summary>
        /// <param name="param">if set to <c>true</c> [parameter].</param>
        public void SetClaimBasedAuthenticationMode(bool param)
        {
            if(param)
            {
                claimBasedAuthentPrefix = "i:0#.w|";
            }
            else
            {
                claimBasedAuthentPrefix = string.Empty;
            }
        }
    } //End Class
} //End Namespace